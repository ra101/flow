...
import {
  BubbleMenu, type BubbleMenuProps,
...
import { SimpleTooltip, TooltipProvider } from '@/components/primitives/tooltip';
...
export const EditorClearFormatting = ({
  ...
  return (
    <SimpleTooltip tip="Clear Formatting">
    <p>
      <BubbleMenuButton
  ...
  return (
    <Popover modal onOpenChange={onOpenChange} open={open}>
      <PopoverTrigger asChild>
        <Button
          className="gap-2 rounded-none border-none z-50"
          size="sm"
          variant="ghost"
        >
      ...
      <PopoverContent
        align="start"
        className={cn('w-48 p-1 z-50', className)}
        sideOffset={5}
        {...props}
      >
        {children}
...
export const EditorTableHeaderColumnToggle = () => {
  ...
  return (
    <SimpleTooltip tip="Toggle header column">
      <Button
...
export const EditorTableHeaderRowToggle = () => {
  ...
  return (
    <SimpleTooltip tip="Toggle header row">
      <Button
        className="flex items-center gap-2 rounded-full"
        onClick={handleClick}
        size="icon"
...
export const EditorTableDelete = () => {
  ...
  return (
    <SimpleTooltip tip="Delete table">
      <Button
        className="flex items-center gap-2 rounded-full"
        onClick={handleClick}
        size="icon"
...
export const EditorCharacterCount = {
  ...
  ReadTime: () => {
    ...
    return (
      <span className='absolute right-9 bottom-7 text-sm italic'>
        {"Read Time: "}
        {Math.ceil(editor.storage.characterCount.words()/256)}
        {" min"}
      </span>
    );
  },
